...
export default function LinkedAccountsBlock({
	...
	if (socialsList?.length == 0 || !socialsList) {
		return (
			<View style={styles.innerContainer}>
				<View style={{ borderColor: colors.tint }}>
					<CustomIcon name='user-circle' collectionKey='fa' size={60} />
				</View>
				<Text style={{ color: colors.tint }}>
					{t('Modals.LinkedAccounts.NoAccounts')}
				</Text>
			</View>
		);
	}
